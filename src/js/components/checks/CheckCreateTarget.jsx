  ...
  renderInner(){
    return (
      <div>
        ...
        <EnvList onTargetSelect={this.handleTargetSelect} filter={this.props.filter} onFilterChange={this.props.onFilterChange} include={['groups.security', 'groups.elb', 'instances.ecc']}/>
      </div>
    );
  },
  renderAsPage(){
