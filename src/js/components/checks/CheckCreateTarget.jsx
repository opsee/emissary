  ...
  renderInner(){
    return (
      <div>
        ...
        <EnvList onTargetSelect={this.handleTargetSelect} filter={this.props.filter} onFilterChange={this.props.onFilterChange} include={['groupsSecurity', 'groupsELB', 'instancesECC']}/>
      </div>
    );
  },
  renderAsPage(){
