            ...
            <Col xs={12}>
              <Panel>
                ...
                <ol>
                  ...
                  <li><strong>Internal (AWS)</strong>: If you add <a href="/docs/instance">our instance</a> to your AWS environment, it will run checks on targets in your AWS environment</li>
                </ol>
