            ...
            <Col xs={12}>
              <Panel>
                ...
                <ol>
                  ...
                  <li><strong>Team</strong>: Our Team plan costs $10 per month for each check. If you have more than one check you are eligible for the Developer plan. All Opsee features, including historical data and multi-user access, are available at this level.</li>
                </ol>

                <Heading level={2}>Trial</Heading>
                <p>Every paid plan includes a 14-day free trial. The trial starts when you select the paid plan and enter a credit card number. You will not be billed until the end of your trial.</p>
